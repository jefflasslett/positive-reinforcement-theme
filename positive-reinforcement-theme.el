...
(custom-theme-set-faces
 ...
 `(font-lock-comment-face              ((,cterm (             :foreground ,pr-grn2     ))))
 ...
 `(font-lock-keyword-face              ((,cterm (:bold ,cterm :foreground ,pr-blue3    ))))
 `(font-lock-negation-char-face        ((,cterm (             :foreground ,pr-gray3    ))))
 `(font-lock-preprocessor-face         ((,cterm (             :foreground ,pr-orng1    ))))
 `(font-lock-string-face               ((,cterm (             :foreground ,pr-orng2    ))))
 ...
 `(font-lock-comment-delimiter-face    ((t (:slant normal     :foreground ,pr-grn2     ))))
